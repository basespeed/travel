            ...
            <div class="giao_dich_moi add_user add_khach_san edit_nv">
                ...
                <form action="<?php echo get_permalink(); ?>" method="post" enctype="multipart/form-data">
                    <ul>
                        <li>
                            <label>ID DT</label>
                            <input type="text" name="id_dt" class="id_dt" value="<?php echo get_field('id_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Mã DT</label>
                        ...
                        <li>
                            <label>Tên DT</label>
                            <input type="text" name="ten_dt" class="ten_dt" value="<?php echo get_field('ten_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Email DT</label>
                            <input type="email" name="email_dt" class="email_dt" value="<?php echo get_field('email_dt'); ?>" required>
                        </li>
                        <li>
                            <label>STK DT</label>
                            <input type="number" name="stk_dt" class="stk_dt" value="<?php echo get_field('stk_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Khu vực DT</label>
                            <input type="text" name="khu_vuc_dt" class="khu_vuc_dt" value="<?php echo get_field('khu_vuc_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Miêu tả DT</label>
                            <input type="text" name="mieu_ta_dt" class="mieu_ta_dt" value="<?php echo get_field('mieu_ta_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Cấp bậc DT</label>
                            <input type="text" name="cap_bac_dt" class="cap_bac_dt" value="<?php echo get_field('cap_bac_dt'); ?>" required>
                        </li>
                        <li>
                            <label>MST DT</label>
                            <input type="text" name="mst_dt" class="mst_dt" value="<?php echo get_field('mst_dt'); ?>" required>
                        </li>
                        <li>
                            <label>SĐT DT</label>
                            <input type="number" name="sdt_dt" class="sdt_dt" value="<?php echo get_field('sdt_dt'); ?>" required>
                        </li>
                        <li>
                            <label>Địa chỉ DT</label>
                            <input type="text" name="dia_chi_dt" class="dia_chi_dt" value="<?php echo get_field('dia_chi_dt'); ?>" required>
                        </li>
