            ...
            <div class="giao_dich_moi add_user add_khach_san edit_ctv">
                ...
                <form action="<?php echo get_permalink(); ?>" method="post" enctype="multipart/form-data">
                    <ul>
                        <li>
                            <label>ID CTV</label>
                            <input type="text" name="id_ctv" class="id_ctv" value="<?php echo get_field('id_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>Mã CTV</label>
                            <input type="text" name="ma_ctv" class="ma_ctv" value="<?php echo get_field('ma_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>Tên CTV</label>
                            <input type="text" name="ten_ctv" class="ten_ctv" value="<?php echo get_field('ten_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>Email CTV</label>
                            <input type="email" name="email_ctv" class="email_ctv" value="<?php echo get_field('email_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>SĐT CTV</label>
                            <input type="number" name="sdt_ctv" class="sdt_ctv" value="<?php echo get_field('sdt_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>Nick KH CTV</label>
                            <input type="text" name="nick_kh_ctv" class="nick_kh_ctv" value="<?php echo get_field('nick_kh_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>Link FB KH CTV</label>
                            <input type="text" name="link_fb_kh_ctv" class="link_fb_kh_ctv" value="<?php echo get_field('link_fb_kh_ctv'); ?>" required>
                        </li>
                        <li>
                            <label>UIDFB KH CTV</label>
                            <input type="text" name="uidfb_kh_ctv" class="uidfb_kh_ctv" value="<?php echo get_field('uidfb_kh_ctv'); ?>" required>
                        </li>
