    ...
    <div class="quantri_admin">
        ...
        <div class="content_admin">
                        ...
                        if(isset($_POST['sub_edit_giao_dich'])){
                            ...
                            if ($query->have_posts()) {
                                while ($query->have_posts()) : $query->the_post();
                                    if (get_field('ma_dich_vu_gd') == $_POST['ma_dich_vu_gd'] and $this_ma_dich_vu_gd != $_POST['ma_dich_vu_gd']) {
                                        $alert = "<p class='alert_tk_fail'>Mã dịch vụ đã tồn tại !</p>";
                                    }elseif (get_field('ma_dt') == $_POST['ma_dt'] and $this_ma_dt != $_POST['ma_dt']) {
                                        $alert = "<p class='alert_tk_fail'>Mã đối tác đã tồn tại !</p>";
            ...
            /*                    acf_form(array(
                                    'post_id'   => get_the_ID(),
                                    'post_title'    => false,
                                    'field_groups' => array(214,312,410,508,605,703,801,899,998,1192,1241,1290,1339,1388,1438,1487,1536),
