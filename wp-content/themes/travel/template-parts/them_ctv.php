                ...
                <div class="giao_dich_moi add_user add_khach_san">
                    ...
                    <form action="<?php echo home_url('/'); ?>them-moi-cong-tac-vien" method="post"
                        ...
                        <ul>
                            <li>
                                <label>ID CTV</label>
                                <input type="text" name="id_ctv" class="id_ctv" required>
                            </li>
                            <li>
                                <label>Mã CTV</label>
                                <input type="text" name="ma_ctv" class="ma_ctv" required>
                            </li>
                            <li>
                                <label>Tên CTV</label>
                            ...
                            <li>
                                ...
                                <input type="text" name="nick_kh_ctv" class="nick_kh_ctv" required>
                            </li>
                            <li>
                                <label>Link FB KH CTV</label>
                                <input type="text" name="link_fb_kh_ctv" class="link_fb_kh_ctv" required>
                            </li>
                            <li>
                                <label>UIDFB KH CTV</label>
                                <input type="text" name="uidfb_kh_ctv" class="uidfb_kh_ctv" required>
                            </li>
