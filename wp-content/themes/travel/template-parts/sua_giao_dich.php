                        ...
                        if ($the_query->have_posts()) :
                            ...
                            while ($the_query->have_posts()) : $the_query->the_post();
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        echo date("d/m/Y", strtotime(get_field('ci_gd')));
                                        ?></td>
                                    <td><?php
                                        echo date("d/m/Y", strtotime(get_field('co_gd')));
                                        ?></td>
                                    ...
                                    <td><?php
                                        echo date("d/m/Y", strtotime(get_field('ngay_yeu_cau_kh_hoan_tat_tt_khac')));
                                        ?></td>
